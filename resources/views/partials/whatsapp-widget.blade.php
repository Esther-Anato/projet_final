...
<div id="wa-widget" class="fixed right-5 bottom-20 lg:bottom-5 z-50">
    ...
    <div id="wa-panel"
        ...
        <div class="bg-[#128C7E] text-white px-4 py-4 flex items-center gap-3">
            <div
                class="w-11 h-11 rounded-full bg-bj-violet-dk text-bj-or grid place-items-center font-display font-bold text-sm shrink-0">
                BJ</div>
            <div>
        ...
        <div class="p-4">
            ...
            <a href="https://wa.me/{{ $waNumber }}?text={{ urlencode('Bonjour Blac Joyaux, j\'ai une question.') }}"
                ...
                <svg class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                    <path
                        d="M12 2a10 10 0 0 0-8.6 15l-1.3 4.8 4.9-1.3A10 10 0 1 0 12 2zm5.8 14.2c-.2.7-1.4 1.3-2 1.4-.5.1-1.2.1-1.9-.1-.4-.1-1-.3-1.7-.6-3-1.3-4.9-4.3-5-4.5-.2-.2-1.2-1.6-1.2-3s.7-2.1 1-2.4c.2-.3.5-.4.7-.4h.5c.2 0 .4 0 .6.5l.8 2c.1.1.1.3 0 .5l-.4.5-.3.3c-.1.1-.3.3-.1.6.2.3.8 1.3 1.7 2.1 1.2 1 2.1 1.4 2.4 1.5.3.1.5.1.6-.1l.7-.9c.2-.3.4-.2.6-.1l2 .9c.2.1.4.2.4.3.1.2.1.9-.1 1.6z" />
                </svg>
    ...
    <button id="wa-fab" aria-label="Ouvrir le chat WhatsApp" aria-expanded="false"
        ...
        <span id="wa-dot"
            class="absolute -top-0.5 -right-0.5 w-[18px] h-[18px] rounded-full bg-red-500 text-white text-[11px] font-bold grid place-items-center border-2 border-bj-creme">1</span>
        ...
        (function() {
            ...
            function toggle() {
                ...
                if (isOpen) {
                    ...
                    panel.classList.add(...closeCls);
                } else {
                    panel.classList.remove(...closeCls);
